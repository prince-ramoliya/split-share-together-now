...
const ExpenseSplitter = () => {
  ...
  const results = currentStep === 'results' ? (() => {
    const calculation = calculateExpenseSplit(people);
    return {
      balances: calculation.balances.reduce((acc, balance) => {
        acc[balance.name] = balance.balance;
        return acc;
      }, {} as Record<string, number>),
      totalExpense: calculation.totalExpense,
      perPersonShare: calculation.perPersonShare,
